...
export function buildTradingAnalysisPrompt(payload: AnalysisPayload): string {
  return [
    ...
    "All explanations, reasoning, summaries, risk notes, checklist items, and final user-facing content MUST be written in Vietnamese. Only enum values and symbols may remain in English.",
