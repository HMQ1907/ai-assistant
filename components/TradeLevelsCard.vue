  ...
  <section class="card">
    ...
    <div class="kv">
      <div class="kv-row">
        ...
        ><strong
          >{{ result.entry_zone.from }} - {{ result.entry_zone.to }}</strong
        >
      </div>
      <div class="kv-row">
        <span>Stop loss</span><strong>{{ result.stop_loss }}</strong>
      </div>
      <div class="kv-row">
        <span>Take profit</span><strong>{{ result.take_profit }}</strong>
      </div>
      <div class="kv-row">
      ...
      <div class="kv-row">
        <span>Rủi ro</span
        ><strong
          >{{ result.position_sizing.risk_percent }}% / ${{
            result.position_sizing.max_loss_usd
          }}</strong
        >
      </div>
      <p class="muted">{{ result.position_sizing.suggested_lot }}</p>
    </div>
  </section>
</template>
