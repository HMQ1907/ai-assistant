<template>
  <main class="page">
    <div class="toolbar">
      <div class="heading">
        <h1>AI {{ symbol }} Trading Assistant</h1>
        <p>
          Phân tích {{ symbol }} bằng dữ liệu thị trường thật và tin tức thật. Công cụ
      ...
      <div class="action-panel">
        ...
        <AnalyzeButton :loading="loading" :symbol="symbol" @analyze="analyze" />
      </div>
    </div>
